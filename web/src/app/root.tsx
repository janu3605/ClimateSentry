...
// Define Route type inline since './+types/root' is missing
type Route = {
  ErrorBoundaryProps: {
    error?: unknown;
...
if (globalThis.window && globalThis.window !== undefined) {
  globalThis.window.fetch = ((input: RequestInfo | URL, init?: RequestInit) =>
    fetch(
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex flex-col gap-2 flex-1">
            <div className="flex flex-col gap-1">
              <p className="font-light text-[#F2F2F2] text-sm">ClimateSentry AI Error Detected</p>
              <p className="text-[#959697] text-sm font-light">
                It looks like an error occurred while trying to use ClimateSentry AI.
              </p>
            </div>
            {children}
          </div>
